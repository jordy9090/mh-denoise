...
def should_call_denoiser(sft_metrics, args):
    ...
    if sft_metrics["risk_score"] > args.gate_risk_threshold:
...
def response_metrics(q, response, score, sft_word_count=None):
...
def main():
    ...
    for raw in tqdm(rows):
        ...
        sft_metrics = response_metrics(q, sft_response, sft_score)
        ...
        if call_denoiser:
            ...
            den_metrics = response_metrics(q, denoiser_response, den_score, sft_word_count=sft_metrics["word_count"])
